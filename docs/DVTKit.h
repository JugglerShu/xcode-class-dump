...
/*
 * File: /Developer/Library/PrivateFrameworks/DVTKit.framework/Versions/A/DVTKit
 * UUID: B5DC8D7C-55FA-369C-988C-492E834F11BF
 * Arch: Intel x86-64 (x86_64)
 *       Current version: 589.0.0, Compatibility version: 1.0.0
...
@protocol DVTParagraphMarkers <NSObject>
@end
...
@property NSShadow *iconShadow; // @synthesize iconShadow=_iconShadow;
...
@property NSGradient *slotGradient; // @synthesize slotGradient=_slotGradient;
@property NSGradient *knobGradient; // @synthesize knobGradient=_knobGradient;
...
@property(readonly) void *uniqueContext; // @synthesize uniqueContext=_uniqueContext;
...
@interface DVTReplacementView : DVTAutoLayoutView <DVTEditor>
{
...
+ (void)initialize;
@property(copy) Class controllerClass; // @synthesize controllerClass=_controllerClass;
...
@property id <DVTReplacementViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void)discardEditing;
- (BOOL)commitEditingForAction:(int)arg1 errors:(id)arg2;
...
- (void)layoutBottomUp;
- (void)layoutTopDown;
@property DVTViewController *installedViewController;
...
@interface DVTControllerContentView : DVTAutoLayoutView
{
...
@property int verticalContentViewResizingMode; // @synthesize verticalContentViewResizingMode=_verticalContentViewResizingMode;
@property int horizontalContentViewResizingMode; // @synthesize horizontalContentViewResizingMode=_horizontalContentViewResizingMode;
@property int verticalAlignmentWhenClipping; // @synthesize verticalAlignmentWhenClipping=_verticalAlignmentWhenClipping;
@property int horizontalAlignmentWhenClipping; // @synthesize horizontalAlignmentWhenClipping=_horizontalAlignmentWhenClipping;
@property struct CGSize minimumContentViewFrameSize; // @synthesize minimumContentViewFrameSize=_minContentFrameSize;
@property int verticalAlignmentWhenPadding; // @synthesize verticalAlignmentWhenPadding=_verticalAlignmentWhenPadding;
@property int horizontalAlignmentWhenPadding; // @synthesize horizontalAlignmentWhenPadding=_horizontalAlignmentWhenPadding;
@property struct CGSize maximumContentViewFrameSize; // @synthesize maximumContentViewFrameSize=_maxContentFrameSize;
@property DVTViewController *viewController; // @synthesize viewController=_viewController;
...
@property NSArray *diffDescriptors; // @synthesize diffDescriptors=_diffDescriptors;
...
@property int style;
@property NSIndexSet *toggledDiffDescriptorIndexes; // @synthesize toggledDiffDescriptorIndexes=_toggledDiffDescriptorIndexes;
@property DVTSourceTextView *secondaryTextView; // @synthesize secondaryTextView=_secondaryTextView;
@property DVTSourceTextView *primaryTextView; // @synthesize primaryTextView=_primaryTextView;
@property(readonly) BOOL showsPrettySwitch;
@property NSIndexSet *selectedDiffDescriptorIndexes; // @synthesize selectedDiffDescriptorIndexes=_selectedDiffDescriptorIndexes;
...
@interface DVTStackView : DVTAutoLayoutView
{
...
@property CDStruct_bf6d4a14 subviewInset; // @synthesize subviewInset;
@property double subviewSpacing; // @synthesize subviewSpacing;
@property int layoutDirection; // @synthesize layoutDirection;
- (void)willRemoveSubview:(id)arg1;
- (void)didAddSubview:(id)arg1;
- (void)viewDidMoveToSuperview;
- (void)viewWillMoveToSuperview:(id)arg1;
...
@interface DVTAutoLayoutViewObservanceKey : NSObject
{
    id object;
    NSString *keyPath;
}
...
@interface DVTDisclosureView : DVTAutoLayoutView <DVTDraggableView, DVTIssueDisplayingView>
{
    NSView *contentView;
...
- (BOOL)isFlipped;
@property DVTDisclosureHeaderView *headerView; // @dynamic headerView;
- (void)encodeWithCoder:(id)arg1;
- (id)initWithCoder:(id)arg1;
- (id)initWithFrame:(struct CGRect)arg1;
...
@property NSData *mergeTextDigest; // @synthesize mergeTextDigest=_mergeTextDigest;
...
@property DVTSourceTextStorage *mergeTextStorage; // @synthesize mergeTextStorage=_mergeTextStorage;
@property NSUndoManager *undoManager; // @synthesize undoManager=_undoManager;
@property id <DVTDiffSessionDelegate> delegate; // @synthesize delegate=_delegate;
@property unsigned long long timestamp; // @synthesize timestamp=_timestamp;
@property NSString *diffString; // @synthesize diffString=_diffString;
...
@property NSIndexSet *modifiedDescriptorIndexes; // @synthesize modifiedDescriptorIndexes=_modifiedDescriptorIndexes;
@property NSIndexSet *commonDescriptorIndexes; // @synthesize commonDescriptorIndexes=_commonDescriptorIndexes;
@property NSArray *diffDescriptors; // @synthesize diffDescriptors=_diffDescriptors;
...
@property NSArray *mergeDescriptors; // @synthesize mergeDescriptors=_mergeDescriptors;
...
@property BOOL showDisclosureButton; // @synthesize showDisclosureButton=_showDisclosureButton;
...
- (void)drawRect:(struct CGRect)arg1;
- (struct CGLayer *)backgroundLayerForCurrentHeight;
...
@property NSButton *disclosureButton;
...
@property(copy) NSColor *inactiveTitleTextColor; // @synthesize inactiveTitleTextColor=_inactiveTitleTextColor;
@property(copy) NSColor *subtitleTextColor; // @synthesize subtitleTextColor=_subtitleTextColor;
@property(copy) NSFont *subtitleFont; // @synthesize subtitleFont=_subtitleFont;
...
@property(readonly) NSColor *toolbarTexturedControlInactiveShadowColor;
@property(readonly) NSColor *toolbarTexturedControlActiveShadowColor;
@property(readonly) NSColor *toolbarTexturedControlInactiveBorderColor;
@property(readonly) NSColor *toolbarTexturedControlActiveBorderColor;
@property(readonly) NSGradient *toolbarTexturedControlInactiveGradient;
@property(readonly) NSGradient *toolbarTexturedControlActiveGradient;
...
@interface DVTSplitViewAnimation : NSAnimation <NSAnimationDelegate>
{
    ...
    unsigned long long _amountShiftedSoFar;
...
@interface DVTBorderedView : DVTAutoLayoutView <DVTShadowDrawing>
{
...
@property id <DVTTabbedWindowControlling> tabbedWindowController; // @synthesize tabbedWindowController;
...
@property DVTViewController<DVTTabbedWindowTabContentControlling> *tabContentController; // @synthesize tabContentController=_tabContentController;
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;
- (id)_computeTabLabel;
...
@property DVTTabbedWindowTabViewItem *editingTab; // @synthesize editingTab=_editingTab;
@property DVTTabbedWindowTabViewItem *selectedTabViewItem; // @synthesize selectedTabViewItem=_selectedTabViewItem;
...
@property DVTViewController *mainViewController; // @synthesize mainViewController=_mainViewController;
...
@property unsigned long long finderMode; // @synthesize finderMode=_finderMode;
...
@property id findObject; // @synthesize findObject=_findObject;
@property NSObject<DVTFindBarHostable> *delegate; // @synthesize delegate=_delegate;
- (void)layoutControls;
@property(readonly, getter=isValid) BOOL valid;
- (void)invalidate;
- (BOOL)control:(id)arg1 textView:(id)arg2 doCommandBySelector:(SEL)arg3;
...
@property DVTFindBar *hostFindBar; // @synthesize hostFindBar=_hostFindBar;
- (void)layoutTopDown;
...
@property id <DVTAnnotationManagerDelegate> delegate; // @synthesize delegate=_delegate;
@property DVTAnnotationContext *context; // @synthesize context=_context;
@property NSMutableArray *annotationProviders; // @synthesize annotationProviders=_annotationProviders;
...
@property BOOL usesGraphicalPlaceholder; // @synthesize usesGraphicalPlaceholder=_usesGraphicalPlaceholder;
@property DVTTextFold *folds; // @synthesize folds=_topLevelFold;
...
@property BOOL severeBubbleAnnotationsMiniaturized; // @synthesize severeBubbleAnnotationsMiniaturized=_severeBubbleAnnotationsMiniaturized;
...
@interface DVTParagraphInfoTable : NSObject
{
    unsigned long long _capacity;
    unsigned long long _count;
    struct DVTParagraphInfo *_paragraphs;
...
@property(readonly) unsigned long long numberOfParagraphs;
...
@interface DVTParagraphMarker : NSObject <DVTParagraphMarkers>
{
}
...
@property NSView *controlView; // @synthesize controlView=_controlView;
...
@property(copy) NSColor *foldbarBackgroundColor; // @synthesize foldbarBackgroundColor=_foldbarBackgroundColor;
@property(copy) NSColor *sidebarBackgroundColor; // @synthesize sidebarBackgroundColor=_sidebarBackgroundColor;
@property(copy) NSColor *lineNumberTextColor; // @synthesize lineNumberTextColor=_lineNumberTextColor;
@property NSFont *lineNumberFont; // @synthesize lineNumberFont=_lineNumberFont;
@property BOOL drawsLineNumbers; // @synthesize drawsLineNumbers=_drawsLineNumbers;
@property double sidebarWidth; // @synthesize sidebarWidth=_sidebarWidth;
@property BOOL showsFoldbar; // @synthesize showsFoldbar=_showsFoldbar;
...
- (void)_drawLineNumbersInSidebarRect:(struct CGRect)arg1 foldedIndexes:(unsigned long long *)arg2 count:(unsigned long long)arg3 linesToInvert:(id)arg4 getParaRectBlock:(id)arg5;
...
{
    NSMutableAttributedString *_contents;
    DVTParagraphInfoTable *_paragraphInfoTable;
...
@interface DVTSourceTextView : DVTCompletingTextView <NSAnimationDelegate, NSLayoutManagerDelegate>
{
    ...
    NSHashTable *_visibleViewAnnotations;
...
@property BOOL autoHighlightTokens; // @synthesize autoHighlightTokens=_autoHighlightTokens;
@property int findResultStyle; // @synthesize findResultStyle=_findResultStyle;
@property unsigned long long pageGuideColumn; // @synthesize pageGuideColumn=_pageGuideColumn;
@property(readonly) NSArray *visualizations; // @synthesize visualizations=_visualizations;
@property DVTAnnotationManager *annotationManager; // @synthesize annotationManager=_annotationManager;
@property struct _NSRange ghostStringRange; // @synthesize ghostStringRange=_ghostStringRange;
...
@property NSColor *tokenizedEditingSelectedTokenBackgroundColor; // @dynamic tokenizedEditingSelectedTokenBackgroundColor;
@property NSColor *tokenizedEditingSelectedTokenBorderColor; // @dynamic tokenizedEditingSelectedTokenBorderColor;
@property NSColor *tokenizedEditingTokenBackgroundColor; // @dynamic tokenizedEditingTokenBackgroundColor;
@property NSColor *tokenizedEditingTokenBorderColor; // @dynamic tokenizedEditingTokenBorderColor;
...
@property NSImage *messageBubbleIcon; // @synthesize messageBubbleIcon=_messageBubbleIcon;
@property(copy) NSString *messageBubbleText; // @synthesize messageBubbleText=_messageBubbleText;
@property(getter=isMiniaturized) BOOL miniaturized; // @synthesize miniaturized=_miniaturized;
- (id)annotationDisplayDescription;
@property id <DVTMessageBubbleAnnotationDelegate> delegate;
...
+ (void)initialize;
@property id <DVTTextAnnotationDelegate> delegate; // @synthesize delegate=_delegate;
...
@property double sidebarMarkerOpacity; // @synthesize sidebarMarkerOpacity=_sidebarMarkerOpacity;
@property unsigned long long highlightSidebarStyle; // @synthesize highlightSidebarStyle=_highlightSidebarStyle;
@property double sidebarMarkerHorizontalOffset; // @synthesize sidebarMarkerHorizontalOffset=_sidebarMarkerHorizontalOffset;
@property double sidebarMarkerVerticalPadding; // @synthesize sidebarMarkerVerticalPadding=_sidebarMarkerVerticalPadding;
@property(retain) NSImage *sidebarMarkerImage; // @synthesize sidebarMarkerImage=_sidebarMarkerImage;
...
@property(readonly, getter=isParagraphEdited) BOOL paragraphEdited;
...
@property DVTMessageBubbleView *annotationView; // @synthesize annotationView=_annotationView;
- (void)setCurrentProgress:(float)arg1;
- (void)stopAnimation;
- (void)startAnimation;
...
@property long long maxAlternatingRowBackgroundLevelInGroupRow; // @synthesize maxAlternatingRowBackgroundLevelInGroupRow=_maxAlternatingRowBackgroundLevelInGroupRow;
@property BOOL groupRowBreaksAlternatingRowBackgroundCycle; // @synthesize groupRowBreaksAlternatingRowBackgroundCycle=_groupRowBreaksAlternatingRowBackgroundCycle;
@property BOOL dvtAcceptsFirstMouse; // @synthesize dvtAcceptsFirstMouse=_dvtAcceptsFirstMouse;
@property id itemUnderHoveredMouse; // @synthesize itemUnderHoveredMouse=_itemUnderHoveredMouse;
...
- (id)progressIndicatorForItem:(id)arg1 createIfNecessary:(BOOL)arg2;
- (BOOL)acceptsFirstMouse:(id)arg1;
- (void)setDelegate:(id)arg1;
- (id)initWithCoder:(id)arg1;
- (id)initWithFrame:(struct CGRect)arg1;
...
@interface DVTTableView : NSTableView
{
    int _emptyContentStringStyle;
    NSString *_emptyContentString;
    NSTextField *_emptyContentTextField;
...
- (BOOL)supportsFindBarMode:(unsigned long long)arg1;
- (BOOL)supportsFindBarType:(unsigned long long)arg1;
@property id <DVTBasicFindBarFindable> findObject;
...
- (BOOL)supportsFindBarMode:(unsigned long long)arg1;
- (BOOL)supportsFindBarType:(unsigned long long)arg1;
@property id <DVTTextFindable> findObject;
- (void)findBarLostFocus;
- (void)performFindHighlightingFirstResult:(BOOL)arg1 informDelegate:(BOOL)arg2;
- (void)replaceAll:(id)arg1;
- (void)replaceAndFindPrevious:(id)arg1;
...
+ (id)defaultAnimationForKey:(id)arg1;
@property double collapsedHeight; // @synthesize collapsedHeight=_collapsedHeight;
...
// Remaining properties
@property id <DVTSourceTextStorageDelegate> delegate; // @dynamic delegate;
...
@property DVTToolbarViewController *viewController; // @synthesize viewController=_viewController;
...
@interface DVTLibraryController : DVTViewController
{
    ...
    struct __CFSet *_uniquedGroupSets;
...
@property NSArray *draggedPairs; // @synthesize draggedPairs=_draggedPairs;
@property(copy) NSArray *draggedGroups; // @synthesize draggedGroups=_draggedGroups;
@property long long assetViewStyle; // @synthesize assetViewStyle=_assetViewStyle;
...
- (void)confirmDeleteAlertDidEnd:(id)arg1 returnCode:(long long)arg2 contextInfo:(void *)arg3;
...
+ (id)defaultImage;
@property(copy) id groupComparator; // @synthesize groupComparator=_groupComparator;
@property DVTAbstractLibraryGroup *parentGroup; // @synthesize parentGroup=_parentGroup;
...
@property DVTLibraryController *libraryController; // @synthesize libraryController=_libraryController;
@property(readonly) NSString *identifier; // @synthesize identifier=_identifier;
@property(readonly) NSArray *orderedLibrarySourceIdentifiers; // @synthesize orderedLibrarySourceIdentifiers=_orderedLibrarySourceIdentifiers;
...
- (void)setOrderedLibrarySourceIdentifiers:(id)arg1;
...
@property NSDate *lastUsedDate; // @synthesize lastUsedDate=_lastUsedDate;
@property(copy) NSString *subtitle; // @synthesize subtitle=_subtitle;
@property(readonly) NSString *identifier; // @synthesize identifier=_identifier;
@property(copy) NSAttributedString *fullDescription; // @synthesize fullDescription=_fullDescription;
@property DVTLibrary *library; // @synthesize library=_library;
...
@property int emptyContentStringStyle; // @synthesize emptyContentStringStyle=_emptyContentStringStyle;
@property NSString *emptyContentString; // @synthesize emptyContentString=_emptyContentString;
- (void)rightMouseDown:(id)arg1;
...
@property id <DVTTileViewDelegate> delegate;
...
@interface DVTFirstResponderDrawingStrategy : NSObject
{
    NSView *_view;
...
@property id <DVTGroupedTileViewDelegate> delegate;
- (id)initWithCoder:(id)arg1;
- (id)initWithFrame:(struct CGRect)arg1;
...
@property BOOL drawsFocusRing; // @synthesize drawsFocusRing=_drawsFocusRing;
- (void)setFrameOrigin:(struct CGPoint)arg1;
- (void)setFrameSize:(struct CGSize)arg1;
- (void)drawRect:(struct CGRect)arg1;
- (void)viewWillDraw;
...
@interface DVTAssetDetailView : DVTAutoLayoutView <DVTReplacementViewDelegate>
{
...
@property NSView *editingView; // @synthesize editingView=_editingView;
@property id delegate; // @synthesize delegate=_delegate;
@property NSEvent *lastMouseDown; // @synthesize lastMouseDown=_lastMouseDown;
...
@property(copy) NSString *helpIdentifier; // @synthesize helpIdentifier=_helpIdentifier;
@property(copy) NSAttributedString *label; // @synthesize label=_label;
@property NSImage *image; // @synthesize image=_image;
...
@property DVTTextCompletionSession *currentSession; // @synthesize currentSession=_currentSession;
...
@property id <DVTTextCompletionDataSourceDelegate> delegate; // @synthesize delegate=_delegate;
...
@property NSTableColumn *typeColumn; // @synthesize typeColumn=_typeColumn;
...
@property int hideReason; // @synthesize hideReason=_hideReason;
...
- (void)clickedOnCell:(id)arg1 inRect:(struct CGRect)arg2 atIndexInToken:(unsigned long long)arg3;
- (BOOL)isThereOnlyATokenAttachmentAtRealRange:(struct _NSRange)arg1;
- (void)replaceSelectedTokenWithNewline;
...
@property NSDictionary *draggingSourceContext; // @synthesize draggingSourceContext=_draggingSourceContext;
@property(readonly) NSPasteboard *draggingPasteboard; // @synthesize draggingPasteboard=_draggingPasteboard;
@property NSImage *draggedImage; // @synthesize draggedImage=_draggedImage;
@property struct CGPoint draggedImageLocation; // @synthesize draggedImageLocation=_draggedImageLocation;
@property id draggingSource; // @synthesize draggingSource=_draggingSource;
...
@property NSWindow *draggingDestinationWindow; // @synthesize draggingDestinationWindow=_draggingDestinationWindow;
@property DVTDraggedImageState *draggedImageState; // @synthesize draggedImageState=_draggedImageState;
...
@interface DVTDynamicTableView : DVTTableView <NSTableViewDelegate, NSTableViewDataSource>
{
    ...
    double *_tableRowHeightCache;
    struct CGRect _lastLayoutBounds;
    NSView *_lastHeaderView;
    long long _lastSectionHeaderDisplayed;
...
@property id <DVTDynamicTableViewDataSource> dynamicDataSource; // @synthesize dynamicDataSource=_dynamicDataSource;
- (BOOL)tableView:(id)arg1 shouldSelectRow:(long long)arg2;
...
- (void)noteHeightOfRow:(long long)arg1 inSectionChanged:(long long)arg2;
...
- (void)viewWillDraw;
@property id <DVTDynamicTableViewDelegate> dynamicDelegate;
...
@interface DVTPlistModel : NSObject <DVTTextFindable, DVTTextReplacable>
{
...
@property DVTPlistNode *selectedNode; // @synthesize selectedNode=_selectedNode;
- (void)invalidate;
- (BOOL)validateUserInterfaceItem:(id)arg1;
...
@property DVTTextVisualization *visualization; // @synthesize visualization=_visualization;
- (void)setCurrentProgress:(float)arg1;
...
@property(copy) NSArray *runLoopModes; // @synthesize runLoopModes=_runLoopModes;
...
@property NSViewAnimation *viewAnimation; // @synthesize viewAnimation=_viewAnimation;
@property NSView *rightContentView; // @synthesize rightContentView=_rightContentView;
@property NSView *leftContentView; // @synthesize leftContentView=_leftContentView;
@property DVTComparisonSplitView *splitView; // @synthesize splitView=_splitView;
- (void)finalize;
...
@property BOOL showsState; // @synthesize showsState=_showsState;
...
@property BOOL showDisclosureButton; // @synthesize showDisclosureButton=_showDisclosureButton;
@property DVTImageAndTextCell *imageAndTextCell; // @synthesize imageAndTextCell=_imageAndTextCell;
@property NSTextFieldCell *textCell; // @synthesize textCell=_textCell;
- (void)drawRect:(struct CGRect)arg1;
- (id)initWithFrame:(struct CGRect)arg1;

@end

@interface DVTComparisonScrollCoordinator : NSObject <DVTSourceTextScrollViewDelegate>
{
...
+ (id)logAspect;
+ (void)initialize;
@property NSIndexSet *modifiedDiffDescriptorIndexes; // @synthesize modifiedDiffDescriptorIndexes=_modifiedDiffDescriptorIndexes;
@property(copy) NSArray *diffDescriptors; // @synthesize diffDescriptors=_diffDescriptors;
@property DVTComparisonScroller *globalScroller; // @synthesize globalScroller=_globalScroller;
@property DVTSourceTextScrollView *rightScrollView; // @synthesize rightScrollView=_rightScrollView;
@property DVTSourceTextScrollView *leftScrollView; // @synthesize leftScrollView=_leftScrollView;
...
+ (id)annotationProviderForContext:(id)arg1 error:(id *)arg2;
@property id <DVTObservingToken> selectionToken; // @synthesize selectionToken=_selectionToken;
@property id <DVTObservingToken> observingToken; // @synthesize observingToken=_observingToken;
...
@property BOOL showsDismissButton; // @synthesize showsDismissButton=_showsDismissButton;
...
@property(readonly) struct CGRect expressionFrame; // @synthesize expressionFrame=_expressionFrame;
...
- (id)description;
- (id)initWithExpressionString:(id)arg1 frame:(struct CGRect)arg2 symbolString:(id)arg3 location:(id)arg4 symbolDescription:(id)arg5 andContext:(id)arg6;
- (id)initWithExpressionString:(id)arg1 frame:(struct CGRect)arg2 symbolString:(id)arg3 location:(id)arg4 textSelectionString:(id)arg5 textSelectionLocation:(id)arg6 symbolDescription:(id)arg7 andContext:(id)arg8;
...
@property DVTDiffDescriptor *diffDescriptor;
- (BOOL)hideCarets;
...
@property DVTLibraryDetailPopUpController *popUpController; // @synthesize popUpController=_popUpController;
@property id <DVTLibraryDetailPopUpContentControllerDelegate> delegate; // @synthesize delegate=_delegate;
@property DVTChoice *selectedDetailControllerChoice; // @synthesize selectedDetailControllerChoice=_selectedDetailControllerChoice;
@property NSArray *detailControllerChoices; // @synthesize detailControllerChoices=_detailControllerChoices;
...
@property DVTHUDPopUpController *windowController; // @synthesize windowController=_windowController;
...
@property BOOL hidesArrow; // @synthesize hidesArrow=_hidesArrow;
@property(copy) id doneButtonClickHandlerBlock; // @synthesize doneButtonClickHandlerBlock=_doneButtonClickHandlerBlock;
@property BOOL hostWindowCanBecomeKey; // @synthesize hostWindowCanBecomeKey=_hostWindowCanBecomeKey;
...
- (void)setWindowOrigin:(struct CGPoint)arg1 clipToSreen:(BOOL)arg2;
...
@property double arrowPoint; // @synthesize arrowPoint=_arrowPoint;
...
@property id <DVTPreferenceSet> currentPreferenceSet;
...
@property unsigned long long columnNumber; // @synthesize columnNumber=_columnNumber;
- (void)drawUnderTextInRect:(struct CGRect)arg1;
...
@property BOOL findWraps; // @synthesize findWraps=_findWraps;
@property BOOL findIgnoresCase; // @synthesize findIgnoresCase=_findIgnoresCase;
@property unsigned long long findType; // @synthesize findType=_findType;
...
+ (void)initialize;
+ (Class)cellClass;
@property BOOL hidesProgress; // @synthesize hidesProgress=_hidesProgress;
@property(readonly) NSProgressIndicator *progressIndicator; // @synthesize progressIndicator=_progressIndicator;
@property(copy) id searchMenuBlock; // @synthesize searchMenuBlock=_searchMenuBlock;
- (void)mouseExited:(id)arg1;
- (void)mouseEntered:(id)arg1;
...
- (void)setMenu:(id)arg1;
@property id <DVTDelayedMenuButtonDelegate> delegate;
...
@property(copy) NSImage *arrowImage; // @synthesize arrowImage=_arrowImage;
...
@property id <DVTDelayedMenuButtonDelegate> delegate; // @synthesize delegate=_delegate;
...
@property NSResponder *initialResponder; // @synthesize initialResponder=_initialResponder;
@property DVTLibraryDetailController *currentDetailController; // @synthesize currentDetailController=_currentDetailController;
@property(readonly) id didEditHandlerBlock; // @synthesize didEditHandlerBlock=_didEditHandlerBlock;
@property DVTLibraryAsset *editedAsset; // @synthesize editedAsset=_editedAsset;
...
@property long long selectedCompletionIndex; // @synthesize selectedCompletionIndex=_selectedCompletionIndex;
@property(copy) NSString *usefulPrefix; // @synthesize usefulPrefix=_usefulPrefix;
@property NSArray *filteredCompletionsPriority; // @synthesize filteredCompletionsPriority=_filteredCompletionsPriority;
@property NSArray *filteredCompletionsAlpha; // @synthesize filteredCompletionsAlpha=_filteredCompletionsAlpha;
@property NSArray *allCompletions; // @synthesize allCompletions=_allCompletions;
@property unsigned long long cursorLocation; // @synthesize cursorLocation=_cursorLocation;
...
@property BOOL usedInToolbar; // @synthesize usedInToolbar=_usedInToolbar;
...
@interface DVTApplicationActionMonitorToken : NSObject
{
    id _handlerBlock;
}
...
{
    id _completionInfoPanelClosedBlock;
}

@property(copy) id completionInfoPanelClosedBlock; // @synthesize completionInfoPanelClosedBlock=_completionInfoPanelClosedBlock;
- (void)close:(id)arg1;
...
@property id buttonTarget; // @synthesize buttonTarget=_buttonTarget;
@property SEL buttonAction; // @synthesize buttonAction=_buttonAction;
@property NSImage *highlightImage; // @synthesize highlightImage=_highlightImage;
@property NSImage *alternateImage; // @synthesize alternateImage=_alternateImage;
@property NSImage *image; // @synthesize image=_image;
- (void)encodeWithCoder:(id)arg1;
- (id)initWithCoder:(id)arg1;
- (id)copyWithZone:(struct _NSZone *)arg1;
...
@property NSFont *fontValue;
@property id fontRepresentation;
@property id <DVTFontTextFieldDataSource> dataSource;
- (id)initWithCoder:(id)arg1;
- (id)initWithFrame:(struct CGRect)arg1;
- (void)_commonInit;
...
@property id <DVTFontTextFieldDataSource> dataSource; // @synthesize dataSource=_dataSource;
@property BOOL previewFont; // @synthesize previewFont=_previewFont;
@property id fontRepresentation; // @synthesize fontRepresentation=_fontRepresentation;
@property NSFont *fontValue; // @synthesize fontValue=_fontValue;
- (void)windowDidResignKey:(id)arg1;
- (void)unbind:(id)arg1;
- (void)bind:(id)arg1 toObject:(id)arg2 withKeyPath:(id)arg3 options:(id)arg4;
...
@interface DVTColorPickerPopUpButton : NSView <NSCoding, NSMenuDelegate>
{
    id target;
    SEL action;
    NSMenu *colorsMenu;
...
- (void)unbind:(id)arg1;
- (void)bind:(id)arg1 toObject:(id)arg2 withKeyPath:(id)arg3 options:(id)arg4;
- (void)observedColorListDidChangeToValue:(id)arg1;
...
@property double imageToTextSpacing; // @synthesize imageToTextSpacing=_imageToTextSpacing;
...
// Remaining properties
@property NSOperationQueue *diffQueue; // @dynamic diffQueue;
@property(readonly) NSMutableArray *mutableDiffDescriptors; // @dynamic mutableDiffDescriptors;
@property NSNumber *timestamp; // @dynamic timestamp;
@property NSMutableArray *tmpDiffDescriptors; // @dynamic tmpDiffDescriptors;
...
@property(nonatomic) NSTextField *styleLabel; // @synthesize styleLabel=_styleLabel;
@property(nonatomic) NSTextField *familyLabel; // @synthesize familyLabel=_familyLabel;
...
@property(retain, nonatomic) NSButton *fontPanelButton; // @synthesize fontPanelButton=_fontPanelButton;
...
@property(nonatomic) DVTFontTextField *fontTextField; // @synthesize fontTextField=_fontTextField;
- (void)alternateButtonAction:(id)arg1;
- (id)alternateButtonLabel;
- (void)awakeFromNib;
...
- (void)setDvt_frameAsString:(id)arg1;
- (id)dvt_frameAsString;
- (void)dvt_toggleFullScreen:(id)arg1;
- (BOOL)dvt_inFullScreenMode;
@end
...
+ (id)dataFromBase64EncodedString:(id)arg1;
- (id)stringValue;
@end
